...
The Fuel Tank API is currently being rebuilt — the mutations on this page are out of date and **will not work against the current Enjin Platform API**. Refer back to this page once support lands.
:::
