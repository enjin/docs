...
- A [Collection](doc:creating-collections) and a [Token](doc:creating-tokens) to freeze.
:::
...
To learn more, check out the [Using WalletConnect page](doc:using-wallet-connect).
:::
