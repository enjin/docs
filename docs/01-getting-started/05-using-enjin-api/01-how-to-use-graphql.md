...
If you wish to execute GraphQL requests programmatically from your local environment or a cloud-based application, you will need to utilize the actual GraphQL endpoint URL. It can be found [here](/01-getting-started/05-using-enjin-api/05-using-enjin-api.md#graphql-endpoint).
#### Testnet:
