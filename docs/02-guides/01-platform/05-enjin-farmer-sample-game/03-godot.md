...
The client's server URL is defined by the `host` variable in [`scripts/enjin/api/enjin_api_service.gd`](https://github.com/enjin/platform-sample-game-client-godot/blob/52b336743cf3d5dd8f34399206bf457b6e214450/scripts/enjin/api/enjin_api_service.gd#L19), which defaults to `http://localhost:3000`. If your server runs elsewhere, update that value.
...
1.  **Health Check**: On startup, `enjin_api_service.gd` [calls `/api/auth/health-check`](https://github.com/enjin/platform-sample-game-client-godot/blob/52b336743cf3d5dd8f34399206bf457b6e214450/scripts/enjin/api/enjin_api_service.gd#L27) to confirm the server is reachable.
2.  **Login/Register**: From the main menu the player registers or logs in, which calls [`EnjinManager.register_and_login()`](https://github.com/enjin/platform-sample-game-client-godot/blob/52b336743cf3d5dd8f34399206bf457b6e214450/scripts/enjin/core/enjin_manager.gd#L66). That posts to the [`/api/auth/register`](https://github.com/enjin/platform-sample-game-client-godot/blob/52b336743cf3d5dd8f34399206bf457b6e214450/scripts/enjin/api/enjin_api_service.gd#L38) endpoint (used for both register and login).
