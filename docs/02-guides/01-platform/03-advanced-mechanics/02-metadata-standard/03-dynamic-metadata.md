...
2.  Set this attribute using the `batchSetCollectionAttribute` action on `CreateTransaction`. You can copy/paste the example below into the [GraphiQL playground](https://platform.enjin.io/graphiql) and change the values.
