...
- A [Collection](/02-guides/01-managing-tokens/01-creating-collections.md) or a [Token](/02-guides/01-managing-tokens/02-creating-tokens/02-creating-tokens.md) to burn/destroy.
:::
