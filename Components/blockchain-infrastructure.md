...
updatedAt: "Sat Nov 11 2023 21:53:45 GMT+0000 (Coordinated Universal Time)"
---
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ed26cd3-spaces_QNacTKEfL1BilhQnECr7_uploads_cHNN4G7wtSuIOYWTdtOu_image.webp",
        "",
        ""
      ],
      "align": "center"
...
5. Inclusivity and Accessibility: Enjin Blockchain is founded on the principles of inclusivity and accessibility. It provides an opportunity for anyone to participate in network security and earn Enjin Coin rewards. With pre-configured packages, anyone can deploy a <<glossary:Validator Node>>, <<glossary:Collator>> Node, or Nomination Pool without the need for complex technical knowledge, making it easy for users to contribute to the network. This approach ensures that the network is open and accessible to all, promoting inclusivity and community involvement.
